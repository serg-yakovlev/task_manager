...
class MainWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        button_update_proc_tree = ProcessTreeUpdateButton()
        button_update_proc_tree.connect("clicked", self.update_proc_tree)
        button_box.pack_start(button_update_proc_tree, True, True, 0)
